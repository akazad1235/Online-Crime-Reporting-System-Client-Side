...
const Sidebar = () => {
    return (
        <div className="sidebar my-5">
           <li className="text-white my-2"><i class="fas fa-braille"></i><Link to="/addComplain" className="p-3 text-white">Dashboar</Link></li>
           ...
           <li className="text-white my-2"><i class="fas fa-plus-circle"></i><Link to="/viewProfile" className="p-3 text-white">Affair</Link></li> 
        </div>
    );
};
